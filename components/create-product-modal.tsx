...
export function CreateProductModal() {
  ...
  const handleInputChange = (
    ...
    if (type === "checkbox") {
      ...
      if (name === "reference" && formData.enableIndividualReferences && productInstances.length > 0) {
  ...
  const generateReferenceNumbers = () => {
    const updatedInstances = productInstances.map((instance, index) => {
      ...
      const shouldUpdate = !instance.referenceNumber.trim() || 
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => 
                    setFormData({ ...formData, enableIndividualReferences: checked })
                  }
                />
              </div>
              <p className="text-sm text-muted-foreground mt-2">
                Create individual instances with unique reference numbers for detailed tracking
              </p>
            </CardHeader>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Pattern: {formData.reference || "PROD001"}-001, {formData.reference || "PROD001"}-002...
                      </p>
                    </div>
                    <Button
                      type="button"
